...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        #    torch.backends.cudnn.benchmark = True changed
        self.loss_names = []
        self.model_names = []
        self.visual_names = []
        self.optimizers = []
    ...
    # def update_learning_rate(self) removed
    ...
    def get_current_losses(self): # check
    ...
    def save_networks(self, epoch): #adapt
    ...
    def load_networks(self, epoch): # adapt
...
class Pix2PixModel(BaseModel):
    ...
    #def modify_commandline_options(parser, is_train=True) #removed
    ...
    def set_input(self, input):
        ...
        """
        # AtoB = self.opt.direction == 'AtoB' # changed
        AtoB = True
        self.real_A = input['A' if AtoB else 'B'].to(self.device)
        self.real_B = input['B' if AtoB else 'A'].to(self.device)
        # self.image_paths = input['A_paths' if AtoB else 'B_paths'] # changed
...
# def get_scheduler(optimizer, opt) removed
...
# unused
# def cal_gradient_penalty(netD, real_data, fake_data, device, type='mixed', constant=1.0, lambda_gp=10.0) removed


#class ResnetGenerator(nn.Module) removed

#class ResnetBlock(nn.Module) removed
